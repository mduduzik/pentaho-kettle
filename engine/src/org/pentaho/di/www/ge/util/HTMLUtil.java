...
public class HTMLUtil {
	...
	public static String escape(String text, int type) throws CharacterCodingException {
		if (text == null) {
			return null;
		}
	...
	public String escapeAttribute(String attribute) throws CharacterCodingException {
		return escape(attribute, ESCAPE_MODE_ATTRIBUTE);
	}

	public String escapeCSS(String css) throws CharacterCodingException {
	...
	public String escapeJS(String js) throws CharacterCodingException {
		return escape(js, ESCAPE_MODE_JS);
	}

	public String escapeURL(String url) throws CharacterCodingException {
